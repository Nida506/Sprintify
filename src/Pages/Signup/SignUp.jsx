...
<div className="absolute bottom-[2%] right-[5%] w-[100px] h-[100px] rounded-full bg-gradient-to-b from-blue-600 to-pink-400 md:bottom-[3px] md:right-[10px] md:w-[200px] md:h-[200px]">
</div>
      {/* Navbar */}
      ...
      {/* Main Section */}
      <div className="flex w-full max-w-7xl items-center justify-between mt-3 px-4 md:px-10 flex-col lg:flex-row">
        {/* Left Section */}
