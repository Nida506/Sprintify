...
const MainFooter = () => {
  return (
    <footer className="bg-[#091054] font-trebuchet text-white md:py-[50px] md:px-[100px] p-[23px] ">
          ...
          <ul className="space-y-4 text-[#FFFFFF] opacity-[75%]">
            <li>
              <a href="#" className="hover:underline">
                Twitter <span className="text-xl pl-[5px]">↗</span>
              </a>
            </li>
            <li>
              <a href="#" className="hover:underline">
                LinkedIn <span className="text-xl pl-[5px]">↗</span>
              </a>
            </li>
            <li>
              <a href="#" className="hover:underline">
                Facebook <span className="text-xl pl-[5px]">↗</span>
              </a>
            </li>
            <li>
              <a href="#" className="hover:underline">
                Instagram <span className="text-xl pl-[5px]">↗</span>
              </a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-6 text-[#FFFFFF] opacity-[75%]">
            <div className="flex gap-[10px]">
              ...
              <div
                data-aos="zoom-in"
                className="border-[1px] border-white p-[12px]  rounded-md"
              >
            ...
            <div className="flex gap-[10px]">
              ...
              <div
                data-aos="zoom-in"
                className="border-[1px] border-white text-white p-[12px] rounded-md"
              >
                <FaEnvelope />
              </div>
              <div className="flex flex-col gap-[1px]">
