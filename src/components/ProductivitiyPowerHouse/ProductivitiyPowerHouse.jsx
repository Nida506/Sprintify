    ...
    <div className=" p-5 flex justify-center w-full overflow-x-hidden">
      <div className=" xl:w-[80%]">
        ...
        <div className="flex gap-7 min-[843px]:justify-around  p-5 max-[843px]:flex-col max-[843px]:items-center">
          <div className="max-[843px]:min-w-[300px] max-[843px]:max-w-[400px] max-[843px]:flex-col min-[843px]:w-1/3 shadow-2xl p-3 py-5 ml-0 overflow-x-hidden"  data-aos="zoom-out" data-aos-duration="500">
          ...
          <div className="max-[843px]:min-w-[300px] max-[843px]:max-w-[400px] 2xl:w-[400px] min-[843px]:w-1/3 shadow-2xl p-3  py-5 overflow-x-hidden" data-aos="zoom-in" data-aos-duration="500" >
          ...
          <div className="max-[843px]:min-w-[300px]  max-[843px]:max-w-[400px] 2xl:w-[400px] min-[843px]:w-1/3 shadow-2xl p-3  py-5 overflow-x-hidden" data-aos="zoom-out" data-aos-duration="500">
